...
[IDEIM_mA_elem, ~, IDEIM_mA_bound ]     = DEIM_Index_to_Elements('matrix', HyRED.IDEIM_m,   ndf, node_to_element, ...
    node_to_boundary, FOM.MESH.internal_dof, FOM.MESH.numNodes);

[IDEIM_rhs_elem, ~, IDEIM_rhs_bound]    = DEIM_Index_to_Elements('rhs',    HyRED.IDEIM_rhs, ndf, node_to_element, ...
    node_to_boundary, FOM.MESH.internal_dof, FOM.MESH.numNodes);
