...
% Dirichlet
data.bcDir{1} = @(x,y,t,param)( deform_boundary(x,y,t,[1 param]) ) ;%deform_boundary(x,y,t,param) );  
data.bcDir{2} = @(x,y,t,param)( deform_boundary(x,y,t,[2 param]) ) ;%deform_boundary(x,y,t,param) );  
