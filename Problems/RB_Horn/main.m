...
% [U, FE_SPACE, MESH, DATA]  = Elliptic2D_Solver(elements, vertices, boundaries, fem, 'horn_data', param_test);
...
% get deformed mesh
def_vertices  = RBF_DeformGeometry(mu(ROM.DATA.shape_param), ROM.MESH.vertices);
