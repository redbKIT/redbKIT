function [A_in, F_in, u_Dirichlet] =  ApplyBC_2D(A, F, FE_SPACE, MESH, DATA, t)
%APPLYBC_2D apply boundary conditions for Advc-Diff-React problem in 2D
% 
%   [A_IN, F_IN, U_DIRICHLET] = APPLYBC_2D(A, F, MESH, DATA) given an
...
%
%   [A_IN, F_IN, U_DIRICHLET] = APPLYBC_2D(A, F, MESH, DATA, T) as
