...
ARGS{1}{4} = coder.typeof(0,[20 3000000],[1 1]);
ARGS{1}{5} = coder.typeof(0);
ARGS{1}{6} = coder.typeof(0,[3000000    60],[1 1]);
ARGS{1}{7} = coder.typeof(0,[3000000    60],[1 1]);
ARGS{1}{8} = coder.typeof(0,[3000000    60],[1 1]);
ARGS{1}{9} = coder.typeof(0,[3000000    60],[1 1]);
ARGS{1}{10} = coder.typeof(0,[3000000    60],[1 1]);
ARGS{1}{11} = coder.typeof(0,[1 60],[0 1]);
ARGS{1}{12} = coder.typeof(0,[1 3000000],[0 1]);
ARGS{1}{13} = coder.typeof(0,[1 3000000],[0 1]);
ARGS{1}{14} = coder.typeof(0,[1 3000000],[0 1]);
ARGS{1}{15} = coder.typeof(0,[1 3000000],[0 1]);
ARGS{1}{16} = coder.typeof(0,[20 60],[1 1]);
ARGS{1}{17} = coder.typeof(0,[20 60],[1 1]);
ARGS{1}{18} = coder.typeof(0,[20 60],[1 1]);
ARGS{1}{19} = coder.typeof(0,[1 3000000],[0 1]);
